...
BP_RF = component(3);
LP_IF = component(0.47);
BP_IF = component(1.5);
SPDT = component(1.4, 27, 44);
LNA_RF = component([14, 0.8], 18.5, 31.5);
Mixer_RF = component(6.8, 1, 12);
Mixer_IF = component(5, 1,12);
AGC = component([6.8, 19.5], 7, 28);
