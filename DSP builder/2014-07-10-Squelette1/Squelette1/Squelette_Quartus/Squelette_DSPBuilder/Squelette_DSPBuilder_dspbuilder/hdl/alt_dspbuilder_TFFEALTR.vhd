...
ENTITY alt_dspbuilder_TFFEALTR IS	
	generic
	(
		width		: natural :=1
	);
...
END alt_dspbuilder_TFFEALTR;

ARCHITECTURE SYN OF alt_dspbuilder_TFFEALTR IS
...
BEGIN
-- Use one TFFE for each bit
	genT:for I in 0 to width - 1 generate
		U0 : TFFE	PORT MAP (
			t		=> 	t(I),
			clk		=>	clock,
			ena 	=> 	ena,
